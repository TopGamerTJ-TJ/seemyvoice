...
export default function Privacy() {
  return (
    <LegalLayout title="Privacy Policy" lastUpdated="August 18, 2026">
      <p>
        This Privacy Policy describes how SeeMyVoice handles information when
      ...
      <p>
        SeeMyVoice is designed with privacy in mind. We do not require you to
      ...
      <p>
        SeeMyVoice does not use tracking cookies. Local storage is used
